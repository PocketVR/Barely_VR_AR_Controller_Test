...
var ASM_CONSTS = {
  3444344: () => { return window.screen.width ; },  
 3444377: () => { return window.screen.height; },  
 3444410: ($0, $1) => { var data = JSON.stringify( window.sensor ); stringToUTF8( data, $0, $1 ); return data.length; },  
 3444508: () => { return window.screen.width; },  
 3444540: () => { return window.screen.height; },  
 3444573: () => { (()=>{ window.addEventListener( "resize", ()=>{ engine.refresh(); }); window.sensor = new Object({ x:"0", y:"0", z:"0", w:"0" }); try { const sensor = new AbsoluteOrientationSensor({ frequency: 60 }); sensor.addEventListener( "reading", ()=>{ window.sensor.x = sensor.quaternion[0].toFixed(6); window.sensor.y = sensor.quaternion[1].toFixed(6); window.sensor.z = sensor.quaternion[2].toFixed(6); window.sensor.w = sensor.quaternion[3].toFixed(6); }); sensor.start(); } catch(err) { alert( "gyroscope not found" ); } })(); },  
 3445099: ($0, $1) => { let data = Date.now() + ""; stringToUTF8( data, $0, $1 ); return data.length; },  
 3445181: () => { if (document.fullscreenElement) return 1; },  
 3445227: () => { return document.getElementById('canvas').width; },  
 3445279: () => { return parseInt(document.getElementById('canvas').style.width); },  
 3445347: () => { document.exitFullscreen(); },  
 3445374: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 3445447: () => { if (document.fullscreenElement) return 1; },  
 3445493: () => { return document.getElementById('canvas').width; },  
 3445545: () => { return screen.width; },  
 3445570: () => { document.exitFullscreen(); },  
 3445597: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 3445730: () => { return window.innerWidth; },  
 3445756: () => { return window.innerHeight; },  
 3445783: () => { if (document.fullscreenElement) return 1; },  
 3445829: () => { return document.getElementById('canvas').width; },  
 3445881: () => { return parseInt(document.getElementById('canvas').style.width); },  
 3445949: () => { if (document.fullscreenElement) return 1; },  
 3445995: () => { return document.getElementById('canvas').width; },  
 3446047: () => { return screen.width; },  
 3446072: () => { return window.innerWidth; },  
 3446098: () => { return window.innerHeight; },  
 3446125: () => { if (document.fullscreenElement) return 1; },  
 3446171: () => { return document.getElementById('canvas').width; },  
 3446223: () => { return screen.width; },  
 3446248: () => { document.exitFullscreen(); },  
 3446275: () => { if (document.fullscreenElement) return 1; },  
 3446321: () => { return document.getElementById('canvas').width; },  
 3446373: () => { return parseInt(document.getElementById('canvas').style.width); },  
 3446441: () => { document.exitFullscreen(); },  
 3446468: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 3446526: () => { return screen.width; },  
 3446551: () => { return screen.height; },  
 3446577: () => { return window.screenX; },  
 3446604: () => { return window.screenY; },  
 3446631: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 3446684: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 3446755: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 3446812: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 3447068: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 3447139: () => { if (document.fullscreenElement) return 1; },  
 3447185: () => { return window.innerWidth; },  
 3447211: () => { return window.innerHeight; },  
 3447238: () => { if (document.pointerLockElement) return 1; }
};
